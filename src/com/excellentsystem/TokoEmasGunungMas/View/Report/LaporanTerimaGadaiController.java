...
public class LaporanTerimaGadaiController {
    ...
    @FXML
    private TreeTableColumn<GadaiHead, String> statusColumn;
    ...
    private void getGadai() {
        try (Connection con = Koneksi.getConnection()) {
            allGadai.clear();
            List<GadaiHead> gadai = GadaiHeadDAO.getAllByTglGadaiAndStatusNotLike(con,
                    mulaiTglPicker.getValue().toString(), akhirTglPicker.getValue().toString(), "Batal Gadai");
    ...
    private void printLaporan() {
        try {
            ...
            report.printLaporanTerimaGadai(filterData, mulaiTglPicker.getValue().toString(),
