...
public class DataJenisBarangController {
    ...
    @FXML
    private TableView<Jenis> jenisTable;
    @FXML
    private TableColumn<Jenis, String> kodeJenisColumn;
    @FXML
    private TableColumn<Jenis, String> namaJenisColumn;
    ...
    @FXML
    private TextField namaJenisField;
    @FXML
    ...
    private void deleteJenis(Jenis temp) {
        try (Connection con = Koneksi.getConnection()) {
            if (StokBarangDAO.checkKodeJenis(con, temp.getKodeJenis())) {
